...
let mtimg = document.getElementById("myimage")
let mtimgres = document.getElementById("myresult");
let sonimage = document.querySelectorAll("#sonscontainerimgs img")



function sonimagesrc(srxx) {
  mtimg.src = srxx
  mtimgres.style.backgroundImage = `url("${mtimg.src}")`;
}
